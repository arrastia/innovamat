  ...
  return (
    <svg fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        strokeWidth="1.5"
      />
      <path d="M6.75 18.75H9.75" stroke={color ? color : defaultColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
      <path
      ...
      <path
        ...
        strokeWidth="1.5"
      />
      <path d="M0.75 9.74997H23.25" stroke={color ? color : defaultColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
      <path d="M6.75 5.99997V0.749969" stroke={color ? color : defaultColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
      <path d="M17.25 5.99997V0.749969" stroke={color ? color : defaultColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
    </svg>
  );
};
